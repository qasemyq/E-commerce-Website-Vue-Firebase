<template>
    <div>
        ...
        <nav id="sidebar"  class="sidebar-wrapper">
             <a href="#" id="showSideBar" @click="closeMenu"><i class="fas fa-bars"></i></a>
            <div class="sidebar-content">
                ...
                <div class=" sidebar-item sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <router-link to="/admin/overview" href="#">
                                <i class="fa fa-calendar"></i>
                                <span class="menu-text">Owerview</span>
                             </router-link>
                        </li>
                        <li>
                            <router-link to="/admin/productsp" href="#">
                                <i class="fab fa-amazon"></i>
                                <span class="menu-text">Products</span>
                             </router-link>
                        </li>
                        <li>
                            <router-link to="/admin/orders" href="#">
